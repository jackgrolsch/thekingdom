...
intent_list = ['disagree','agree','help','threaten','call']
tone_list = ['neutral','unfriendly','friendly']

def random_talk(w_count): #The baseline method, juste random arguments for random words
	...
	for i in range(0,w_count):
		...
		word = dic_func.su_pick('/home/jack/projects/thekingdom/dictionnaries/dictionnary_pelb', intent, tone)
		if word:
